...
(function (Game) {
    ...
    let frameCounterStop = 15;//max speed
    ...
    function eatApple() {
        ...
        snake.length++;
        if (apple.color === "#F0E68C") {
            score += 2;
        }
        score++;

        snake.color = RandomSnakeColor();
        // Update the score text
        updateScore();
        console.log(frameCounterLimit);//debug
        //speed limit
        if (frameCounterLimit >= frameCounterStop) {
            //speed
            frameCounterLimit--;
        }
